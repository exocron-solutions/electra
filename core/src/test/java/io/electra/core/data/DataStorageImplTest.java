...
class DataStorageImplTest {
  ...
  private static final byte[] TEST_SINGLE_BLOCK_CONTENT = "I am a tester moarfuckn king."
      .getBytes();
  private static final byte[] TEST_CHAIN_BLOCK_CONTENT1 = "IjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjaja"
      .getBytes();
  private static final byte[] TEST_CHAIN_BLOCK_CONTENT2 = "IjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjajaIjajajajajajajajajajajajajjaja"
      .getBytes();
  ...
  void setUp() throws FileSystemAccessException {
    ...
    Futures.getUnchecked(
        fileSystemAccessor.write(DataBlock.DATA_BLOCK_SIZE * TEST_SINGLE_BLOCK_INDEX, byteBuffer));
    ...
    Futures.getUnchecked(
        fileSystemAccessor.write(DataBlock.DATA_BLOCK_SIZE * TEST_CHAIN_BLOCK_INDEX1, byteBuffer));
    ...
    Futures.getUnchecked(
        fileSystemAccessor.write(DataBlock.DATA_BLOCK_SIZE * TEST_CHAIN_BLOCK_INDEX2, byteBuffer));
  ...
  void testWriteData() {
    ...
    Index resultIndex = Futures
        .getUnchecked(dataStorage.writeData(index, TEST_CHAIN_BLOCK_CONTENT3));
    ...
    assertArrayEquals(Arrays.copyOfRange(TEST_CHAIN_BLOCK_CONTENT3, 0, 120),
        dataRecord.getDataBlocks().get(0).getContent());
  }
